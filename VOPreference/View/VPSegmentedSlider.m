...
const CGFloat VPSegmentedSliderLineSize = 3.0f;
const CGFloat VPSegmentedSliderMargin = 15.0f;
const CGFloat VPSegmentedSliderInternalMargin = 7.0f;

API_AVAILABLE(ios(10.0))
@interface VPSegmentedSlider () <UIGestureRecognizerDelegate>
{
...
@implementation VPSegmentedSlider
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _lineSize = VPSegmentedSliderLineSize;
        _knobPadding = VPSegmentedSliderInternalMargin;
        
        _backColor = [UIColor colorWithRed:0.50 green:0.50 blue:0.50 alpha:0.60];
        _trackColor = [UIColor colorWithRed:0.80 green:0.80 blue:0.80 alpha:1.00];
        _startColor = [UIColor colorWithRed:0.80 green:0.80 blue:0.80 alpha:1.00];
...
- (void)drawRect:(CGRect)__unused rect
{
    ...
    CGFloat margin = VPSegmentedSliderInternalMargin;
